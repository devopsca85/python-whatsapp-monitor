...
class WhatsAppNotifier:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # Config fields
        self.method = self.whatsapp_config.get("method", "twilio").lower()
        self.api_key = self.whatsapp_config.get("api_key", "")
        self.from_number = self.whatsapp_config.get("from_number", "")
        self.to_numbers = self.whatsapp_config.get("to_numbers", [])
        ...
        self.instance_id = self.whatsapp_config.get("instance_id", "")  # ✅ for UltraMsg
